...
export default function NoticiasHero() {
  ...
  useGSAP(
    () => {
      ...
      // Ken Burns: la imagen arranca ligeramente ampliada y se asienta
      if (imgRef.current) {
      ...
      // Contenido: stagger de abajo hacia arriba
      gsap.set(".hero-content", { opacity: 0, y: 36 });
      ...
      // Franja roja: entra desde la derecha
      gsap.from(".noticias-hero-stripe", {
        scaleX: 0,
  ...
  return (
    <section
      ...
      aria-label="Noticias — presentación"
    >
      {/* Imagen con ref para Ken Burns y parallax */}
      <div ref={imgRef} className="absolute inset-0">
        <Image
          src={HERO_IMG}
          alt="Noticias del Cardiocentro Pediátrico de Sucre"
          fill
      ...
      <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12 lg:p-16 pb-14 md:pb-16">
        ...
        >
          <Newspaper size={13} aria-hidden="true" style={{ color: "var(--color-rojo-400)" }} />
        ...
        >
          Mantente al día con el Cardiocentro
        </h1>
        ...
        >
          Tecnología, eventos y novedades institucionales del Cardiocentro
          Pediátrico de Sucre.
        </p>
      </div>

      <div
        className="noticias-hero-stripe absolute bottom-0 right-0 h-1.5"
