...
export default function ServiciosHero() {
  ...
  return (
    ...
    >
      <Image
        src={HERO_IMG}
        alt="Atención especializada en el Cardiocentro Pediátrico de Sucre"
        fill
      ...
      <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12 lg:p-16 pb-14 md:pb-16">
        ...
        >
          Atención especializada para cada diagnóstico
        </h1>
        ...
        >
          Cardiología Pediátrica, Radiología y Diagnóstico por Imágenes en Sucre
          y la región Caribe.
        </p>
      </div>
